...
// //   // FIX: Changed 'pending payment' to 'pending_payment' to match database and _getStatusColor
...
// //     'completed',
// //     'cancelled',
// //     'pending_payment' // FIX: Use snake_case for consistency
// //   ];
...
// //                               value: status,
// //                               // FIX: Format status display name for readability
...
// //                         final String rawStatus = booking['status'] ?? 'N/A';
// //                         final String status = rawStatus.toLowerCase().replaceAll(' ', '_');
...
// //       case 'cancelled':
// //         return Colors.grey;
// //       case 'pending_payment': // This is correctly handled here
