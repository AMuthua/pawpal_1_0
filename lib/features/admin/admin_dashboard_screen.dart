                  ...
                  Expanded(
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        ...
                        // NEW: Support Chats Management Card
                        _buildActionCard(
                          context,
                          icon: Icons.chat_bubble, // Icon for chats
                          title: 'Support Chats',
                          color: const Color(0xFFFDD835), // A warm yellow for chats
                          isDesktop: isDesktop,
                          onTap: () {
                            context.go('/admin_dashboard/support_chats'); // Navigate to the new admin chat screen
                          },
                        ),
                        _buildActionCard(
                          context,
